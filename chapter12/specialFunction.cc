...
namespace specialFunction {
    ...
    public:
        ...
        //无论派生析构被编译器合成与否，都会调用基类析构。调用顺序当然后调用基类析构：先构造，后销毁
        ~Derive()
//                = default;
        {
    ...
    public:
        ...
        Base2(int) {
            std::cout << "Base2 single para ctor is called.\n";
        }
        Base2(const Base2&) {
    ...
    public:
        ...
        Base3(int) {
            std::cout << "Base3 single para ctor is called.\n";
        }
        Base3(const Base3&) {
    ...
    public:
        ...
        Base4(int) {
            std::cout << "Base4 single para ctor is called.\n";
        }
        Base4(const Base4&) {
...
int main() {
    ...
    Derive2 d2(3);//输出：Base2 default ctor is called. 而不是 Base2 single para ctor is called.
