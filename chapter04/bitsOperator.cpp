...
int main() {
    ...
    signed char x1 = -3;
    //x1:1000 .... 0000 0011,但在计算机中是补码表示，x1:1111 .... 1111 1101
    //~x1:0000 .... 0000 0010
    std::cout << ~x1 << std::endl;//~x1是2
    std::cout << (x1 << 1) << std::endl;//x1:1111 .... 1111 1101,移动后1111 1010是补码，原码为1000 .... 0000 0110 为-6
    std::cout << (x1 >> 1) << std::endl;//                             1111 1110是补码，原码为1000 .... 0000 0010 为-2
    ...
    std::cout << "----------" << std::endl;
    //从43和50行看出是integral promotion是符号位都置为1，计算机是这么运行的
